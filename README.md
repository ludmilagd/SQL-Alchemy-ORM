...
Objective:
Use Python and SQLAlchemy ORM queries with provided hawaii.sqlite to reflect tables into a new model and perform analysis of Hawaii climate.
...
Used Pandas to print the summary statistics for the precipitation data. prcp
Station Analysis
